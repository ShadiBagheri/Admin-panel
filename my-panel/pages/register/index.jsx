...
const Register = () => {
    ...
    return(
        <div className="container flex flex-col w-[460px] h-[596px] items-center mt-[50px] mx-auto bg-[#ffffff] border-[1px] border-[#e4e4e4] rounded-[40px]">
            <div className="flex flex-col items-center mt-[35px]">
                <Image className="w-[80px] h-[80.47px]" src={logo} alt="logo"/>
            ...
            <Link href="/login" className="me-64 text-base text-[#3a8bed] font-normal ">حساب کاربری دارید؟</Link>
        </div>
    )
}
